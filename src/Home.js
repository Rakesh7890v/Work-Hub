    ...
    const quotes = [
        {
          id: 1,
          user: 'Sangeetha.V',
          text: 'The task notification feature is a productivity to organized. Great job on enhancing the system!',
          image: user1,
        },
        {
          id: 2,
          user: 'Madhavan.V',
          text: 'The intuitive employee directory and customizable themes make navigation seamless. Well done!',
          image: user2,
        },
        {
          id: 3,
